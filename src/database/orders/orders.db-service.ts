...
import { UserOrderIndexEntry, OrderWithItems } from '@database/interfaces/index';
...
export class OrdersDbService {
  ...
  /**
   * @see OrdersDbRepository.findIndexByUser
   */
  ...
  /**
   * @see OrdersDbRepository.findHotOrders
   */
  ...
  /**
   * @see OrdersDbRepository.findWarmOrders
   */
  ...
  /**
   * @see OrdersDbRepository.findColdOrders
   */
  ...
  /**
   * @see OrdersDbRepository.findOrderById
   */
  ...
  /**
   * @see OrdersDbRepository.createOrder
   */
